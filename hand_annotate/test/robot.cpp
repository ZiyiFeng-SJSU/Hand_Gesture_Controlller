...
int main (int argc, char *argv[])
{
  ...
  {
    printf ("Indice: %d, (%f, %f)\n", face_landmark_element->indice, face_landmark_element->x, face_landmark_element->y);
...
face_landmark_node * stasm (char *face_id, int current_frame)
{
  ...
  static const char* const path = "../data/ORIGINAL-38.1.ppm";
  face_landmark_node *face_landmark_list_head;

  face_landmark_list_head = NULL;
  sprintf (filename, "../data/ORIGINAL-38.1.ppm");
