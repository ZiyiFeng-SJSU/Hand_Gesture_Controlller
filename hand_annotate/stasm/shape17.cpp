...
/* Hand Gesture Media tab */
 static const int hgmp_tab[17] = // 77 points
    {
         0, // 0  Inside Thumb
         5, // 1  thumb knuckle
        10, // 2  tip of thumb
        15, // 3  Between Thumb Index
        19, // 4  Inside Index Knuckle
        22, // 5  First joint of index
        25, // 6  Tip of Index Finger  
        32, // 7  Inside Middle Knuckle
        38, // 8  Tip of Middle
        46, // 9  Inside Ring Knuckle
        51, // 10 Tip of Ring Finger
        59, // 11 Inside Pinkie Knuckle
        63, // 12 Tip of Pinkie
        67, // 13 Middle outside of pinkie
        69, // 14 Outside Pinkie Knuckle
        72, // 15 Outside of palm
        76  // 16 Outside of Wrist
    };
