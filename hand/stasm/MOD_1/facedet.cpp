...
static const double BORDER_FRAC = 0.0;
...
{
    OpenDetector(facedet_g, "../tasm/landtab/new_hand.xml", datadir); //../tasm/landtab/hands_toy.xml",  datadir);
}
    ...
    int          minwidth) // in: as percent of img width
{
    ...
    static const int    DETECTOR_FLAGS = 6; //CV_HAAR_FIND_BIGGEST_OBJECT; // 0|CV_HAAR_SCALE_IMAGE|CV_HAAR_FIND_BIGGEST_OBJECT;
